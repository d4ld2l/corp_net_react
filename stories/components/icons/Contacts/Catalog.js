...
import Catalog from 'components-folder/Icon/Contacts/Catalog'

const stories = storiesOf('Components/Icons/Contacts', module)
    ...
    <div>
      <div className={'stories__wrap'}>
        ...
        <div className={'stories__connect'}>
          <input
            type="text"
            value="import Catalog from 'components-folder/Icon/Contacts/Catalog'"
            id="connect"
