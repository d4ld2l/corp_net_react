...
import DataStorage from 'components-folder/Icon/menu/DataStorage'
    ...
    <div>
      <div className={'stories__wrap'}>
        ...
        <div className={'stories__connect'}>
          <input
            type="text"
            value="import DataStorage from 'components-folder/Icon/menu/DataStorage'"
            id="connect"
