...
import Logo from 'components-folder/Icon/Logo/Logo'

const stories = storiesOf('Components/Icons/Logo', module)
    ...
    <div>
      <div className={'stories__wrap'}>
        ...
        <div className={'stories__connect'}>
          <input
            type="text"
            value="import Logo from 'components-folder/Icon/Logo/Logo'"
            id="connect"
