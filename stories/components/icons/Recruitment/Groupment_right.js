...
import Groupment_right from 'components-folder/Icon/Recruitment/Groupment_right'
...
stories.add(
  'Groupment_right',
  withNotes('Groupment_right')(() => (
    <div>
      <div className={'stories__wrap'}>
        <h2>Groupment_right</h2>
        <div className={'stories__connect'}>
          <input
            type="text"
            value="import Groupment_right from 'components-folder/Icon/Recruitment/Groupment_right'"
            id="connect"
