...
import Recomendation from 'components-folder/Icon/Recruitment/Recomendation'
    ...
    <div>
      <div className={'stories__wrap'}>
        ...
        <div className={'stories__connect'}>
          <input
            type="text"
            value="import Recomendation from 'components-folder/Icon/Recruitment/Recomendation'"
            id="connect"
      ...
      <div className={'stories__wrap'}>
        ...
        <p>
          <strong>filled</strong> — полностью закрашена.
        </p>
      </div>
    </div>
  ))
