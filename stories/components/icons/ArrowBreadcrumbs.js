...
import ArrowBreadcrumbs from 'components-folder/Icon/ArrowBreadcrumbs'
...
stories.add(
  'ArrowBreadcrumbs',
  withNotes('ArrowBreadcrumbs icon')(() => (
    <div>
      <div className={'stories__wrap'}>
        <h2>ArrowBreadcrumbs</h2>
        <div className={'stories__connect'}>
          <input
            type="text"
            value="import ArrowBreadcrumbs from 'components-folder/Icon/ArrowBreadcrumbs'"
            id="connect"
