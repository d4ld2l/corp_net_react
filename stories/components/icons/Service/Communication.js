...
import Communication from 'components-folder/Icon/Service/Communication'
    ...
    <div>
      <div className={'stories__wrap'}>
        ...
        <div className={'stories__connect'}>
          <input
            type="text"
            value="import Communication from 'components-folder/Icon/Service/Communication'"
            id="connect"
