...
import Question from 'components-folder/Icon/Bonus/Question'

const stories = storiesOf('Components/Icons/Bonus', module)
    ...
    <div>
      <div className={'stories__wrap'}>
        ...
        <div className={'stories__connect'}>
          <input
            type="text"
            value="import Question from 'components-folder/Icon/Bonus/Question'"
            id="connect"
