...
import Loupe from 'components-folder/Icon/Header/Loupe'

const stories = storiesOf('Components/Icons/Header', module)
    ...
    <div>
      <div className={'stories__wrap'}>
        ...
        <div className={'stories__connect'}>
          <input
            type="text"
            value="import Loupe from 'components-folder/Icon/Header/Loupe'"
            id="connect"
