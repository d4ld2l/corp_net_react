...
import UserByParts from 'components-folder/Icon/UserByParts'
    ...
    <div>
      <div className={'stories__wrap'}>
        ...
        <div className={'stories__connect'}>
          <input
            type="text"
            value="import UserByParts from 'components-folder/Icon/UserByParts'"
            id="connect"
      ...
      <div className={'stories__wrap'}>
        ...
        <p>
          <strong>outline</strong> — обвидет и зачеркнет.
        </p>
      </div>
    </div>
  ))
