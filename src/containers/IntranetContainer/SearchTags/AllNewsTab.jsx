...
import { Comment } from 'components-folder/Icon'
...
class AllNewsTab extends Component {
  ...
  componentWillMount() {
    const { allNews, catId } = this.props
    let news
    if (catId) {
      news = allNews.filter(el => {
              ...
              <Row>
                <Col xs={2}>
                  ...
                  <div>
                    ...
                    <span className={cn('comment-value')}>120</span>
                  </div>
                </Col>
                <Col xs={10}>
                  <article>
