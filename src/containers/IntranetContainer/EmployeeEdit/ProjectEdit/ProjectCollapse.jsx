...
import { Arrow, Trash, Calendar, Trash } from 'components-folder/Icon/'
    ...
    {fields.map((exp, index) => (
      <div className={cn('wrapper-data')} key={exp}>
        <Field
          ...
          options={options}
        />
        <p className={cn('info-msg')}>Код проекта: INV_OCS_N_MINSV_UNI</p>
    ...
    return (
      <div className={cn} id="statuses">
        ...
        <div className={cn('actions')}>
          <div className={cn('actions-send')}>
            Сохранить
          </div>
          <div className={cn('actions-cancel')}>
            Отменить
          </div>
        </div>
      </div>
